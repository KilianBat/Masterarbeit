...
def main():
    if len(sys.argv) != 2:
        print("Usage: python scripts/geo_run_sam2_experiment.py <config.json>")
        sys.exit(1)
    ...
    # save exact config copy into output folder for reproducibility
